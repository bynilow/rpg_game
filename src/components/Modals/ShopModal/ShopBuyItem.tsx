        ...
        <Item 
            ...
            <InfoBlock>
                <Title $isCanBuy={!!$countCanBuy}>
                    x{$count} {$fullItem.title} ({inventory.find(i => $fullItem.id === i.item.id)?.count || 0})
                </Title>
                <CraftBlock>
                    {
                        $countCanBuy
                    ...
                    }
                    {
                        ...
                        ? <RangeBlock>
                            ...
                            <CountRange 
                                type='range' 
                                min={1} 
                                max={$countCanBuy > $count ? $count : $countCanBuy} 
                                value={rangeCount}
...
interface ICanBuyProps{
    $isCanBuy: boolean;
}

const Cost = styled.p<ICanBuyProps>`
    position: absolute;
    bottom: 0;
    right: 0;
    margin: 10px;
