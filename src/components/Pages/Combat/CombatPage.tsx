...
import { addItemsToInventoryAC, addXPAC, setDeadEnemy, setHealthPoints } from '../../../store/reducers/ActionCreators';
...
function CombatPage({ $enemyId, $finishBattle, $enemyIdInArea, $level }: ICombatPage) {
    ...
    const winCombat = () => {
        ...
        dispatch(addXPAC(items[0].count)); /// first item - is received experience
